...
## Setting the criteria that if budget, revenue and runtime equals to 0, omit the row of dataset 
```{r removing zero values}
summary(movies$runtime)
summary(movies$budget)
summary(movies$revenue)
# Filtering data that equals to 0 
movies_new <- movies
movies_new <- filter(movies, budget > 0, revenue > 0, runtime > 0)
movies_new
# Number of rows - reduced to 4768
nrow(movies_new)
```
...
```{r popularity}
top_20_movies <- head(movies_new[order(movies_new$popularity, decreasing = TRUE), c("title", "popularity")], n = 20)
...
```{r revenue}
highest_profit_movies <- head(movies_new[order(movies_new$revenue, decreasing = TRUE), c("title", "revenue")], n = 20)
...
```{r budget}
highest_budget_movies <- head(movies_new[order(movies_new$budget, decreasing = TRUE), c("title", "budget")], n = 20)
...
```{r genres}
action <- ggplot(movies_new, aes(x = Action)) +
...
adventure <- ggplot(movies_new, aes(x = Adventure)) +
...
animation <- ggplot(movies_new, aes(x = Animation)) +
  geom_bar(aes(y = (..count..)/sum(..count..)), fill = "gold") +
  geom_text(aes(label = scales::percent((..count..)/sum(..count..)),
                y = (..count..)/sum(..count..)), stat = "count", vjust = -.5) +
  scale_y_continuous(labels = scales::percent) +
...
comedy <- ggplot(movies_new, aes(x = Comedy)) +
  geom_bar(aes(y = (..count..)/sum(..count..)), fill = "purple") +
  geom_text(aes(label = scales::percent((..count..)/sum(..count..)),
                y = (..count..)/sum(..count..)), stat = "count", vjust = -.5) +
  scale_y_continuous(labels = scales::percent) +
...
crime <- ggplot(movies_new, aes(x = Crime)) +
  geom_bar(aes(y = (..count..)/sum(..count..)), fill = "purple") +
  geom_text(aes(label = scales::percent((..count..)/sum(..count..)),
                y = (..count..)/sum(..count..)), stat = "count", vjust = -.5) +
  scale_y_continuous(labels = scales::percent) +
...
documentary <- ggplot(movies_new, aes(x = Documentary)) +
  geom_bar(aes(y = (..count..)/sum(..count..)), fill = "gold") +
  geom_text(aes(label = scales::percent((..count..)/sum(..count..)),
                y = (..count..)/sum(..count..)), stat = "count", vjust = -.5) +
  scale_y_continuous(labels = scales::percent) +
...
drama <- ggplot(movies_new, aes(x = Drama)) +
  geom_bar(aes(y = (..count..)/sum(..count..)), fill = "gold") +
  geom_text(aes(label = scales::percent((..count..)/sum(..count..)),
                y = (..count..)/sum(..count..)), stat = "count", vjust = -.5) +
  scale_y_continuous(labels = scales::percent) +
...
family <- ggplot(movies_new, aes(x = Family)) +
  geom_bar(aes(y = (..count..)/sum(..count..)), fill = "purple") +
  geom_text(aes(label = scales::percent((..count..)/sum(..count..)),
                y = (..count..)/sum(..count..)), stat = "count", vjust = -.5) +
  scale_y_continuous(labels = scales::percent) +
...
fantasy <- ggplot(movies_new, aes(x = Fantasy)) +
  geom_bar(aes(y = (..count..)/sum(..count..)), fill = "purple") +
  geom_text(aes(label = scales::percent((..count..)/sum(..count..)),
                y = (..count..)/sum(..count..)), stat = "count", vjust = -.5) +
  scale_y_continuous(labels = scales::percent) +
...
history <- ggplot(movies_new, aes(x = History)) +
  geom_bar(aes(y = (..count..)/sum(..count..)), fill = "gold") +
  geom_text(aes(label = scales::percent((..count..)/sum(..count..)),
                y = (..count..)/sum(..count..)), stat = "count", vjust = -.5) +
  scale_y_continuous(labels = scales::percent) +
...
horror <- ggplot(movies_new, aes(x = Horror)) +
  geom_bar(aes(y = (..count..)/sum(..count..)), fill = "gold") +
  geom_text(aes(label = scales::percent((..count..)/sum(..count..)),
                y = (..count..)/sum(..count..)), stat = "count", vjust = -.5) +
  scale_y_continuous(labels = scales::percent) +
...
music <- ggplot(movies_new, aes(x = Music)) +
  geom_bar(aes(y = (..count..)/sum(..count..)), fill = "purple") +
  geom_text(aes(label = scales::percent((..count..)/sum(..count..)),
                y = (..count..)/sum(..count..)), stat = "count", vjust = -.5) +
  scale_y_continuous(labels = scales::percent) +
...
mystery <- ggplot(movies_new, aes(x = Mystery)) +
  geom_bar(aes(y = (..count..)/sum(..count..)), fill = "purple") +
  geom_text(aes(label = scales::percent((..count..)/sum(..count..)),
                y = (..count..)/sum(..count..)), stat = "count", vjust = -.5) +
  scale_y_continuous(labels = scales::percent) +
...
romance <- ggplot(movies_new, aes(x = Romance)) +
  geom_bar(aes(y = (..count..)/sum(..count..)), fill = "gold") +
  geom_text(aes(label = scales::percent((..count..)/sum(..count..)),
                y = (..count..)/sum(..count..)), stat = "count", vjust = -.5) +
  scale_y_continuous(labels = scales::percent) +
...
sciencefiction <- ggplot(movies_new, aes(x = `Science Fiction`)) +
  geom_bar(aes(y = (..count..)/sum(..count..)), fill = "gold") +
  geom_text(aes(label = scales::percent((..count..)/sum(..count..)),
                y = (..count..)/sum(..count..)), stat = "count", vjust = -.5) +
  scale_y_continuous(labels = scales::percent) +
...
tvmovie <- ggplot(movies_new, aes(x = `TV Movie`)) +
  geom_bar(aes(y = (..count..)/sum(..count..)), fill = "purple") +
  geom_text(aes(label = scales::percent((..count..)/sum(..count..)),
                y = (..count..)/sum(..count..)), stat = "count", vjust = -.5) +
  scale_y_continuous(labels = scales::percent) +
...
thriller <- ggplot(movies_new, aes(x = Thriller)) +
  geom_bar(aes(y = (..count..)/sum(..count..)), fill = "purple") +
  geom_text(aes(label = scales::percent((..count..)/sum(..count..)),
                y = (..count..)/sum(..count..)), stat = "count", vjust = -.5) +
  scale_y_continuous(labels = scales::percent) +
...
war <- ggplot(movies_new, aes(x = War)) +
  geom_bar(aes(y = (..count..)/sum(..count..)), fill = "gold") +
  geom_text(aes(label = scales::percent((..count..)/sum(..count..)),
                y = (..count..)/sum(..count..)), stat = "count", vjust = -.5) +
  scale_y_continuous(labels = scales::percent) +
...
western <- ggplot(movies_new, aes(x = Western)) +
  geom_bar(aes(y = (..count..)/sum(..count..)), fill = "purple") +
  geom_text(aes(label = scales::percent((..count..)/sum(..count..)),
                y = (..count..)/sum(..count..)), stat = "count", vjust = -.5) +
  scale_y_continuous(labels = scales::percent) +
...
```{r runtime}
longest_runtime_movies <- head(movies_new[order(movies_new$runtime, decreasing = TRUE), c("title", "runtime")], n = 20)
...
animation_vote_average <- movies_new %>%
...
thriller_vote_average <- movies_new %>%
...
# Correlation Plot 
```{r correlation plot}
numeric_columns <- sapply(movies_new, is.numeric)
movies_numeric <- movies_new[,numeric_columns]
...
```{r vote popularity}
vote_popularity <- ggplot(movies_new, aes(vote_average, popularity)) + 
...
```{r vote budget}
vote_budget <- ggplot(movies_new, aes(vote_average, budget)) +
