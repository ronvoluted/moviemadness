...
revenue, popularity, budget, vote_count, runtime, Animation, and Drama.
...
tmdb_glm2 = glm(formula = vote_rate ~ revenue + popularity + budget + vote_count + runtime + Animation + Drama,
               data = trainingset,
               family = "gaussian"
                 )
